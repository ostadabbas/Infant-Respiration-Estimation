...
def train_and_test(config, data_loader_dict):
    ...
    elif config.MODEL.NAME == 'VIRENet':
        model_trainer = trainer.VIRENetTrainer.VIRENetTrainer(config, data_loader_dict)
    else:
...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TRAIN.DATA.DATASET == "AIR":
            train_loader = data_loader.AIRLoader.AIRLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "AIR":
            valid_loader = data_loader.AIRLoader.AIRLoader
        ...
        elif config.TEST.DATA.DATASET == "ACL":
            test_loader = data_loader.ACLLoader.ACLLoader
        elif config.TEST.DATA.DATASET == "AIR":
            test_loader = data_loader.AIRLoader.AIRLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC, PURE, SCAMPS, and ACL.")
