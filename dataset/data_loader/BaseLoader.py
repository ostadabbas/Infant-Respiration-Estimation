...
class BaseLoader(Dataset):
    ...
    @staticmethod
    def resample_air(input_signal, target_length):
        """Resampling for impulse oriented signals using scipy resample"""
        return scipy.signal.resample(input_signal, target_length)
