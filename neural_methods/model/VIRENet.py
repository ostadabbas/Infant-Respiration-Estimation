...
class VIRENet(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
        ...
        # First conv
        self.conv0 = nn.Sequential(nn.Conv2d(self.in_channels, self.nb_filters1, kernel_size=self.kernel_size, padding=(1,1),
                                    bias=True),
                                    nn.BatchNorm2d(self.nb_filters1))
        # Motion branch convs
        self.motion_conv1 = nn.Conv2d(self.nb_filters1, self.nb_filters1, kernel_size=self.kernel_size, padding=(1, 1),
                                  bias=True)
    ...
    def forward(self, inputs, params=None):
        ...
        network_input = self.TSM_1(norm_input)
