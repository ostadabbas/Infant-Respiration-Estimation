...
hr_method='FFT', path=None, infant_flag=False):
    ...
    if use_bandpass:
        ...
        if infant_flag:
            # AIR-125 dataset has breath rate for normal infants in the range [18, 60] breaths per min.
            # bandpass filter between [0.3, 1.0] = [18, 60]
            lo, hi = 0.3, 1.0
        else:
